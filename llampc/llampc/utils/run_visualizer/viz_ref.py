...
class StateVisualizer:
    ...
    def _as_points(arr):
        ...
        Handles every shape the producer can emit:
          * a single point as 1D  -> [x, y]      or [x, y, yaw]   (shape (2,)/(3,))
...
def main():
    ...
    filepath = os.path.join(dir_path, 'cbf10.npz')
