...
try:
    ...
    from llampc.rollout import dynamic_lateral as dynamics
...
DEFAULT_LOG_ORDER = ['Bf', 'Br', 'Cf', 'Cr', 'Df', 'Dr']
...
def build_bank(params_bank, params_car, num_models):
    ...
    p = params_bank
    return dynamics.DBMPacejkaLateralBank(
